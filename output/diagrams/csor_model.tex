...
\node[klasse] (Eenheid) at (9.300,-10.800) {\textbf{Eenheid}\\[0.5mm]\footnotesize 359 concepten};
\node[klasse] (KwalificeerbaarAspect) at (3.100,-19.600) {\textbf{KwalificeerbaarAspect}\\[0.5mm]\footnotesize 3 concepten};
\node[klasse] (KwantificeerbaarAspect) at (3.100,-16.000) {\textbf{KwantificeerbaarAspect}\\[0.5mm]\footnotesize 139 concepten};
\node[klasse] (NatuurkundigeDimensie) at (9.300,-16.000) {\textbf{NatuurkundigeDimensie}\\[0.5mm]\footnotesize 49 concepten};
\node[klasse] (Parameter) at (6.200,-3.600) {\textbf{Parameter}\\[0.5mm]\footnotesize 4593 concepten};
\node[klasse] (ParameterAspect) at (6.200,-7.200) {\textbf{ParameterAspect}\\[0.5mm]\footnotesize 8194 concepten};
...
\node[klasse] (Variabele) at (3.100,-0.000) {\textbf{Variabele}\\[0.5mm]\footnotesize 1896 concepten};
...
\draw[rel] (Variabele) edge[loop above, looseness=6, min distance=14mm] node[lbl, pos=0.5] {(0..N, 0..1)\\skos:broader} (Variabele);
\draw[extrel] (Eenheid) -- (QUDT);
\node[extlbl, above] at ($(Eenheid)!0.5!(QUDT)$) {162/359 eenheden\\{\ttfamily 112 broadMatch, 50 exactMatch}};
\draw[extrel] (Variabele) -- (PubChem);
\node[extlbl, above] at ($(Variabele)!0.5!(PubChem)$) {1218/1896 variabelen\\{\ttfamily pubchem:compound (CID-koppeling)}};
\end{tikzpicture}
\end{document}
